...
namespace Notus.Encryption
{
    ...
    {
        public static Notus.Variable.Struct.RSAKeysModel GenerateKeys(int keySize)
        {
            using (var rsa = new RSACryptoServiceProvider(keySize))
            {
                var model = new Notus.Variable.Struct.RSAKeysModel
                {
        ...
        public static string Encrypt(string data, string publicKey)
        {
            ...
            var res = System.Convert.ToBase64String(Encrypt(dataArray, publicKey));
            return res;
        }
        /// <summary>
        ///
        ...
        {
            var dataArray = System.Convert.FromBase64String(data);
        ...
        public static string SignData(string message, string privateKey)
        {
            ...
            return System.Convert.ToBase64String(signedBytes);
        }
        ...
        public static bool VerifyData(string originalMessage, string signedMessage, string publicKey)
        {
            ...
            using (var rsa = new RSACryptoServiceProvider())
            {
                ...
                var signedBytes = System.Convert.FromBase64String(signedMessage);
