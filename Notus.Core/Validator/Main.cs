...
namespace Notus.Validator
{
    public class Main : IDisposable
    {
        ...
        public void EmptyBlockTimerFunc()
        {
            ...
            {
                Notus.Debug.Print.Basic(Obj_Settings, "Timer Has Started");
                ...
                TimerObj.Start(() =>
                {
                    if (EmptyBlockTimerIsRunning == false)
                    {
                        ...
                        //Notus.Debug.Print.Basic(InfoModeActive,"Notus.Validator.Main - Timer Schedule -> " + howManySeconds.ToString());
                        ...
                        {
                            Notus.Debug.Print.Basic(Obj_Settings, "Empty Block Executed");
        ...
        {
            Notus.Debug.Print.Basic(Obj_Settings, "Water Mark Timer Has Started");
        ...
        */
        ...
        {
            Notus.Debug.Print.Basic(Obj_Settings.InfoMode, "File Storage Timer Has Started");
                        ...
                        ObjMp_FileStatus.Each((string tmpStorageId, string rawStatusStr) =>
                        {
                            ...
                            if (tmpDataStatus == Notus.Variable.Enum.BlockStatusCode.Pending)
                            {
                                ...
                                )
                                {
                                    ...
                                    {
                                        Notus.Debug.Print.Basic(Obj_Settings.DebugMode, "Error Text : [9abc546ac] : " + err3.Message);
                                    }
                                    //}
                                    //catch (Exception err)
                                    //{
        ...
        {
            Notus.Debug.Print.Basic(Obj_Settings, "Crypto Transfer Timer Has Started");
            Notus.Threads.Timer TimerObj = new Notus.Threads.Timer(1000);
            TimerObj.Start(() =>
            {
        ...
        public void Start()
        {
            ...
            {
                Notus.Debug.Print.Basic(Obj_Settings, "Notus.Validator.Main -> Genesis Is NULL");
            }
            ...
            */
            ...
            {
                Notus.Debug.Print.Basic(Obj_Settings, "Last Block Row No : " + Obj_Settings.LastBlock.info.rowNo.ToString());
                    ...
                    ObjMp_BlockOrder.Each((string blockUniqueId, string BlockText) =>
                    {
                        ...
                        if (string.Equals(new Notus.Hash().CommonSign("sha1", BlockOrder.Key + Obj_Settings.HashSalt), BlockOrder.Value))
                        {
                            using (Notus.Block.Storage Obj_Storage = new Notus.Block.Storage(false))
                            {
                                ...
                                {
                                    Notus.Debug.Print.Danger(Obj_Settings, "Notus.Block.Integrity -> Block Does Not Exist");
                                }
                            }
                        }
                        else
                        {
                            Notus.Debug.Print.Danger(Obj_Settings, "Hash calculation error");
                        }
                    }, 0
                    );
                }
            ...
            //Notus.Debug.Print.Basic(Settings.InfoMode,"empty count : " + Obj_Integrity.EmptyBlockCount);
            if (Obj_Settings.GenesisCreated == false)
            {
                Notus.Debug.Print.Basic(Obj_Settings, "Main Validator Started");
            }
            ...
            while (tmpExitMainLoop == false)
            {
                ...
                if (bStatus == true)
                {
					...
					*/
                    ...
                    Notus.Debug.Print.Basic(Obj_Settings, "NodeOrder : " + NodeOrder.ToString());
                    ...
                    Notus.Debug.Print.Basic(Obj_Settings, "Block Generated [" + PreparedBlockData.info.type.ToString() + "]: " + PreparedBlockData.info.uID);
                ...
                else
                {
                    if ((DateTime.Now - LastPrintTime).TotalSeconds > 20)
                    {
                        ...
                        {
                            Console.Write(".");
                            // Notus.Debug.Print.Basic(DebugModeActive, "Wait For Request");
                        }
                    }
                    Thread.Sleep(5);
            ...
            Notus.Debug.Print.Warning(Obj_Settings, "Main Class Ended");
        }
        ...
        private void Start_HttpListener()
        {
            ...
            {
                Notus.Debug.Print.Basic(Obj_Settings, "Listining : " +
            ...
            Notus.Debug.Print.Basic(Obj_Settings, "Http Has Started", false);
        }
